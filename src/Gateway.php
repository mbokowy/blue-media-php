...
class Gateway
{
     ...
     */
    private function parseInitTransferResponse(): SimpleXMLElement
    {
     ...
     * @throws RuntimeException
     */
    private function parseTransferResponse(): TransactionBackground
    {
        $xmlData = XMLParser::parse($this->response);
     ...
     * @return int
     */
    private function isPaywayFormResponse(): int
    {
     ...
     *
     */
    public function doItnInResponse(ItnIn $transaction, $transactionConfirmed = true): string
    {
     ...
     * @api
     */
    public function doTransactionStandard(TransactionStandard $transaction): string
    {
        $transaction->setServiceId(self::$serviceId);
     ...
     * @api
     */
    public function doInitTransaction(TransactionInit $transaction): SimpleXMLElement
    {
        $data = $transaction->toArray();
     ...
     *
     */
    final public static function mapModeToDomain($mode): string
    {
     ...
     *
     */
    final public static function mapModeToUrl($mode): string
    {
     ...
     *
     */
    final public static function getActionUrl($action): string
    {
     ...
     * @return string
     */
    final public static function generateHash(array $data): string
    {
        $result = '';
...
//                $value = array_filter($value, 'mb_strlen');
     ...
     * @api
     */
    final public function doPaywayList(): PaywayList
    {
        $fields         = [
            'ServiceID' => self::$serviceId,
